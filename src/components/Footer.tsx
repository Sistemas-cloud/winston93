          ...
          <div className="flex flex-col items-center space-y-2 mt-2">
            ...
            <AnimatedElement animation="fadeInUp" delay={500}>
              <div className="flex items-center gap-3">
                ...
                <a href="#" aria-label="WhatsApp" className="w-7 h-7 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center transition">
                  <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute bottom-14 md:bottom-16 left-1/2 transform -translate-x-1/2 z-20">
            <AnimatedElement animation="fadeInUp" delay={500}>
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <a href="#" aria-label="WhatsApp" className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center transition">
                  <svg className="w-4 h-4 md:w-4 md:h-4" fill="currentColor" viewBox="0 0 24 24">
